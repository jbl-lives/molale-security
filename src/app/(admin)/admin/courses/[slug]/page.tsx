...
// Type for this route's props, expecting a Promise
type PageProps = {
  params: Promise<{
    slug: string;
  }>;
...
// 1. generateMetadata is async, so it can 'await' the params
...
// 2. The Page component is also async, so it can 'await' the params
        ...
        <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
          <div className="relative h-64 md:h-96">
            ...
            <div className="absolute bottom-0 left-0 right-0 p-8 text-white">
              ...
              {/* The closing tag was </pre> before, now it's correctly </p> */}
            </div>
          </div>
          ...
          <div className="p-8 md:p-12">
            <div className="grid md:grid-cols-2 gap-12">
              <div>
                ...
                <pre className="text-gray-700 leading-relaxed text-lg whitespace-pre-wrap font-sans">
                  {course.blurb}
                </pre>
