...
export default function ContactPage() {
  return (
    <main className="w-full bg-gradient-to-b from-white to-gray-50">
      <section className="mx-auto max-w-screen-xl px-4 md:px-6 py-12 md:py-16">
        {/* ...heading... */}

        <div className="grid gap-8 lg:grid-cols-2">
          {/* Left: Form card */}
          <div className="relative rounded-xl bg-[var(--color-primary)] text-white p-6 md:p-8 shadow-[0_20px_60px_rgba(0,0,0,.15)]">
          ...
          <div className="flex flex-col ">
            <h2 className="text-6xl font-semibold mb-8">Get in touch With Us <span className="text-[var(--color-primary)]">Today</span></h2>
            ...
            <ul className="mt-6 space-y-4">
              <li className="flex items-center gap-3 text-gray-800">
                <span className="grid h-10 w-10 place-items-center rounded-full bg-[var(--color-primary)]/10 text-[var(--color-primary)]">
